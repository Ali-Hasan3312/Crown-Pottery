...
const InfoGrid = () => {
  return (
    <div className="grid grid-cols-3 max-sm:grid-cols-1 py-12 w-[84%] mx-auto items-center">
      <div className="flex flex-col gap-4 w-[350px] max-sm:w-[410px]">
        ...
        />
        <h1 className="text-4xl font-semibold">Handcrafted Mugs</h1>
      ...
      <div className="flex flex-col gap-4 w-[350px] max-sm:w-[410px]">
        ...
        />
        <h1 className="text-4xl font-semibold">Brunch Collection</h1>
        <p className="text-sm max-sm:mb-4">
      ...
      <div className="flex flex-col gap-4 w-[350px] max-sm:w-[410px]">
        <img
          ...
          src={drinkware}
        />
        <h1 className="text-4xl font-semibold">Elegant Drinkware</h1>
        <p className="text-sm max-sm:mb-4">
